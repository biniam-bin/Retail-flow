    ...
    return (
        <Flex flexDir="column" width="100%">
            <Flex alignItems="end">
                ...
                <Text mx="0.5rem" color="gray">Products</Text>
            </Flex>
            <Flex>
                <Box onClick={onAddOpen} bg="#007bff" color="white" borderRadius={5} cursor="pointer" my="1.2rem" p="0.35rem 0.8rem"><Text fontSize="sm" size="xl">Add Product</Text></Box>
            </Flex>
            <Flex flexDir="column" borderRadius="5px" p="0.5rem 1rem" pb="1rem" boxShadow="rgba(67, 71, 85, 0.27) 0px 0px 0.25em, rgba(90, 125, 188, 0.05) 0px 0.25em 1em;" bg="#fff">
                ...
                <Flex alignItems="center" mt="2rem">
                    ...
                    <Spacer />
                    <Text>Search: </Text>
                    <Input placeholder='search product' mx="0.5rem" size='sm' width="auto" />
                </Flex>
                    ...
                    <Table variant='striped' colorScheme='gray'>
                        ...
                        <Tbody>
                            <Tr>
                                ...
                                <Td>1500</Td>
                                <Td>6</Td>
                                <Td><Flex><Productstatus status={true} /></Flex></Td>
                                <Td>
                                    <Flex>
            ...
            <DeleteProduct isDeleteOpen={isDeleteOpen} onDeleteClose={onDeleteClose} />
        ...
        <Modal isOpen={isEditOpen} onClose={onEditClose}>
            ...
            <ModalContent>
                ...
                <ModalBody>
                    <FormControl isRequired>
                        <FormLabel>Product name</FormLabel>
                        <Input defaultValue="Ni" placeholder='Product name' />
                    </FormControl>
                    <FormControl my="0.8rem">
                        <FormLabel>Price</FormLabel>
                        <NumberInput defaultValue={0}>
