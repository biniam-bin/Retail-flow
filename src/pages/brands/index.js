...
function Brands() {
    ...
    return (
        <Flex flexDir="column" width="100%">
            ...
            <Flex>
                <Box onClick={onAddOpen} bg="#007bff" color="white" borderRadius={5} cursor="pointer" my="1.2rem" p="0.35rem 0.8rem"><Text fontSize="sm" size="xl">Add Brand</Text></Box>
            </Flex>
            <Flex flexDir="column" borderRadius="5px" p="0.5rem 1rem" pb="1rem" boxShadow="rgba(67, 71, 85, 0.27) 0px 0px 0.25em, rgba(90, 125, 188, 0.05) 0px 0.25em 1em;" bg="#fff">
                ...
                <Flex alignItems="center" mt="2rem">
                    ...
                    <Spacer />
                    <Text>Search: </Text>
                    <Input placeholder='search brand' mx="0.5rem" size='sm' width="auto" />
                </Flex>
                <Flex><TableContainer mt="2rem" width="100%" mx="auto">
                    <Table variant='striped' colorScheme='gray'>
                        ...
                        <Tbody>
                            <Tr>
                                <Td>Nike</Td>
                                <Td><Flex><BrandStatus status={true} /></Flex></Td>
                                <Td>
                                    <Flex>
            ...
            <Flex m={200}></Flex>
            <EditBrand isEditOpen={isEditOpen} onEditClose={onEditClose} />
            <AddBrand isAddOpen={isAddOpen} onAddClose={onAddClose} />
            <DeleteBrand isDeleteOpen={isDeleteOpen} onDeleteClose={onDeleteClose} />
...
function AddBrand({ onAddClose, isAddOpen }) {
    return (
...
function EditBrand({ onEditClose, isEditOpen }) {
    return (
        <Modal isOpen={isEditOpen} onClose={onEditClose}>
            ...
            <ModalContent>
                ...
                <ModalBody>
                    <FormControl isRequired>
                        <FormLabel>Brand name</FormLabel>
                        <Input defaultValue="Ni" placeholder='Brand name' />
                    </FormControl>
                    <FormControl my="0.8rem">
                        <FormLabel>Status</FormLabel>
                        <Select defaultValue="active">
...
function DeleteBrand({ onDeleteClose, isDeleteOpen }) {
    return (
